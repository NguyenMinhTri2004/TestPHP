                    ...
                    <div class="hero-container">
                        <div class="hero-content">
                            ...
                            <p class="text hero-desc">
                                ...
                                <span class="text-medium">LaslesVPN</span> discover interesting features from
                                us.
                            </p>
                            <a href="#" class="button button--primary button--rounded">Get Started</a>
                        </div>
                    ...
                    <div class="plan-list">
                        <div class="plan-item">
                            <div class="plan-image">
                                <img alt="" srcset="./images/plan.png 2x" />
                            </div>
                        ...
                        <div class="plan-item is-active">
                            ...
                            <h4 class="plan-price">Free</h4>
                            <a href="#" class="button button--primary button--shadow">Select</a>
                        </div>
                    </div>
                    <div class="boxed">
    ...
    <section class="customer">
        <div class="container">
            <div class="boxed">
                ...
                <p class="text">These are the stories of our customers who have joined us with great pleasure when using
            ...
            <div class="customer-list">
                <div class="customer-item">
                    <div class="customer-top">
                        <div class="customer-info">
                            ...
                            <div class="customer-content">
                                <h3 class="heading-small customer-name">Viezh Robert</h3>
                                <span class="text-small customer-address">Warsaw, Poland</span>
                            </div>
                        </div>
                    ...
                    <div class="text customer-desc">“Wow... I am very happy to use this VPN, it turned out to be more
                        than my expectations and so far there have been no problems. LaslesVPN always the best”.</div>
                </div>
                <div class="customer-item">
                    <div class="customer-top">
                        <div class="customer-info">
        ...
        <div class="container">
            <div class="footer-container">
                <div class="footer-column">
                    ...
                    <p class="footer-desc text"><span class="text-medium">LaslesVPN</span> is a private virtual network
                        that has unique features and has high security.</p>
                    <div class="social">
